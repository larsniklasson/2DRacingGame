...
public class MultiplayerWorldSyncer implements UpdateListener, RaceListener {
    ...
    /**
     * Assumed latency in ms between client and server.
     * TODO estimate this on the fly for a more individual and realistic approximation
     */
    private static final int ASSUMED_LATENCY = 30;
    ...
    private void moveOpponent(Player opponent, float x, float y, float angle, float frontWheelAngle) {
        ...
        float animationDuration = (MIN_UPDATE_WAIT + ASSUMED_LATENCY) / 1000f;
